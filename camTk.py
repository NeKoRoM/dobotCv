...
class CameraProcessor:
    ...
    def setup_ui(self):
        ...
        self.focus_entry.grid(row=0, column=2, padx=5, pady=5, sticky="w")
        ...
        self.exposure_entry.grid(row=1, column=2, padx=5, pady=5, sticky="w")
        ...
        self.lov_h_entry.grid(row=0, column=2, padx=5, pady=5, sticky="w")
        ...
        self.lov_s_entry.grid(row=1, column=2, padx=5, pady=5, sticky="w")
        ...
        self.lov_v_entry.grid(row=2, column=2, padx=5, pady=5, sticky="w")
        ...
        self.high_h_entry.grid(row=3, column=2, padx=5, pady=5, sticky="w")
        ...
        self.high_s_entry.grid(row=4, column=2, padx=5, pady=5, sticky="w")
        ...
        self.high_v_entry.grid(row=5, column=2, padx=5, pady=5, sticky="w")
