...
class CameraProcessor:
    ...
    def setup_ui(self):
        ...
        self.camera_frame.grid(row=0, column=0, padx=1, pady=1, sticky="nsew")

        self.camera1_frame = ttk.LabelFrame(self.root, text="Camera1")
        self.camera1_frame.grid(row=0, column=1, padx=1, pady=1, sticky="nsew")
        ...
        self.focus_scale.grid(row=0, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera_frame, text="Focus").grid(row=0, column=1, padx=1, pady=1, sticky="w")
        self.focus_entry = ttk.Entry(self.camera_frame, textvariable=self.focus_value, width=5)
        self.focus_entry.grid(row=0, column=2, padx=1, pady=1, sticky="w")
        self.focus_entry.bind("<Return>", self._on_entry_change)
        ...
        self.exposure_scale.grid(row=1, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera_frame, text="Exposure").grid(row=1, column=1, padx=1, pady=1, sticky="w")
        self.exposure_entry = ttk.Entry(self.camera_frame, textvariable=self.exposure_value, width=10)
        self.exposure_entry.grid(row=1, column=2, padx=1, pady=1, sticky="w")
        self.exposure_entry.bind("<Return>", self._on_entry_change)
        ...
        self.lov_h_scale.grid(row=0, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="Low H").grid(row=0, column=1, padx=1, pady=1, sticky="w")
        self.lov_h_entry = ttk.Entry(self.camera1_frame, textvariable=self.lov_h_value, width=5)
        self.lov_h_entry.grid(row=0, column=2, padx=1, pady=1, sticky="w")
        self.lov_h_entry.bind("<Return>", self._on_entry_change)
        ...
        self.lov_s_scale.grid(row=1, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="Low S").grid(row=1, column=1, padx=1, pady=1, sticky="w")
        self.lov_s_entry = ttk.Entry(self.camera1_frame, textvariable=self.lov_s_value, width=5)
        self.lov_s_entry.grid(row=1, column=2, padx=1, pady=1, sticky="w")
        self.lov_s_entry.bind("<Return>", self._on_entry_change)
        ...
        self.lov_v_scale.grid(row=2, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="Low V").grid(row=2, column=1, padx=1, pady=1, sticky="w")
        self.lov_v_entry = ttk.Entry(self.camera1_frame, textvariable=self.lov_v_value, width=5)
        self.lov_v_entry.grid(row=2, column=2, padx=1, pady=1, sticky="w")
        self.lov_v_entry.bind("<Return>", self._on_entry_change)
        ...
        self.high_h_scale.grid(row=3, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="High H").grid(row=3, column=1, padx=1, pady=1, sticky="w")
        self.high_h_entry = ttk.Entry(self.camera1_frame, textvariable=self.high_h_value, width=5)
        self.high_h_entry.grid(row=3, column=2, padx=1, pady=1, sticky="w")
        self.high_h_entry.bind("<Return>", self._on_entry_change)
        ...
        self.high_s_scale.grid(row=4, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="High S").grid(row=4, column=1, padx=1, pady=1, sticky="w")
        self.high_s_entry = ttk.Entry(self.camera1_frame, textvariable=self.high_s_value, width=5)
        self.high_s_entry.grid(row=4, column=2, padx=1, pady=1, sticky="w")
        self.high_s_entry.bind("<Return>", self._on_entry_change)
        ...
        self.high_v_scale.grid(row=5, column=0, padx=1, pady=1, sticky="ew")
        ttk.Label(self.camera1_frame, text="High V").grid(row=5, column=1, padx=1, pady=1, sticky="w")
        self.high_v_entry = ttk.Entry(self.camera1_frame, textvariable=self.high_v_value, width=5)
        self.high_v_entry.grid(row=5, column=2, padx=1, pady=1, sticky="w")
        self.high_v_entry.bind("<Return>", self._on_entry_change)
        self.high_v_value.set(0)

        self.image_label = ttk.Label(self.camera1_frame)
        self.image_label.grid(row=6, column=0, columnspan=3, padx=1, pady=1)

        self.output_image_label = ttk.Label(self.camera_frame)
        self.output_image_label.grid(row=2, column=0, columnspan=3, padx=1, pady=1)
    ...
    def _on_entry_change(self, event):
        ...
        try:
            value = float(value)
            if entry == self.focus_entry:
                self.focus_scale.set(value)
            elif entry == self.exposure_entry:
                self.exposure_scale.set(value)
            elif entry == self.lov_h_entry:
                self.lov_h_scale.set(value)
            elif entry == self.lov_s_entry:
                self.lov_s_scale.set(value)
            elif entry == self.lov_v_entry:
                self.lov_v_scale.set(value)
            elif entry == self.high_h_entry:
                self.high_h_scale.set(value)
            elif entry == self.high_s_entry:
                self.high_s_scale.set(value)
            elif entry == self.high_v_entry:
